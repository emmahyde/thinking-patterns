...
4. **mental_model** - First Principles, Second-Order Thinking, etc.
5. **decision_framework** - Multi-criteria decision analysis
6. **domain_modeling** - Conceptual models of problem domains

### 🔬 Scientific & Critical Analysis
7. **scientific_method** - Hypothesis testing and experimentation
8. **critical_thinking** - Systematic evaluation of arguments
9. **debugging_approach** - Systematic troubleshooting

### 👥 Collaborative & Dialectical
10. **collaborative_reasoning** - Multi-persona perspectives
...
### 📊 Probabilistic
15. **stochastic_algorithm** - Decision-making under uncertainty (MDP, MCTS, Bandits, etc.)
