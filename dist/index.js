...
class DecisionFrameworkServer {
    ...
    processDecisionFramework(input) {
        const validatedData = this.validateInputData(input);
        return {
            ...validatedData,
...
class ScientificMethodServer {
    ...
    processScientificMethod(input) {
        const validatedData = this.validateInputData(input);
        // Process hypothesis
        let finalHypothesis = undefined;
        if (validatedData.hypothesis) {
            finalHypothesis = {
                ...
                status: validatedData.hypothesis.status ?? "proposed",
            };
        }
        // Process experiment
        let finalExperiment = undefined;
...
class StructuredArgumentationServer {
    ...
    processStructuredArgumentation(input) {
        const validatedData = this.validateInputData(input);
        return {
            ...validatedData,
