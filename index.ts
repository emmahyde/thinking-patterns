...
// Stochastic Algorithm Data Interface
...
// Stochastic Algorithm Server (added from stochastic-thinking)
...
// Stochastic Algorithm Tool (added from stochastic-thinking)
...
const server = new Server(
  {
    name: "thinking-patterns-server", // Updated server name
  ...
  },
  {
    capabilities: {
      tools: {
        ...
        stochasticalgorithm: STOCHASTIC_TOOL, // Added stochastic tool
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  switch (request.params.name) {
    ...
    case "stochasticalgorithm": { // Added stochastic request handler
      const result = stochasticServer.processAlgorithm(request.params.arguments);
      return result;
    }
...
async function runServer() {
  ...
  console.error("Thinking Patterns MCP Server running on stdio"); // Updated server message
}
